...
module.exports = {
  ...
  onStart: async function ({ api, event, args }) {
    ...
    const userInfo = {
      name: "(𝗝𝗲𝗿𝗿𝘆)",  // Replace with your name
      age: "Hidden",           // Replace with your age
      location: "Narayanganj",    // Replace with your location
      bio: "Private life is a happy life | Always Learning!", // Replace with your bio
    ...
    const imgurLinks = [
      "http://remakeai-production.up.railway.app/Remake_Ai/Nyx_Remake_1745650120052.mp4",  // Replace with actual Imgur video links
