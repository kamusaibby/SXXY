...
        "অনুমতি দিলাম-𝙋𝙧𝙤𝙥𝙤𝙨𝙚 কর বস 𝐊𝐀𝐌𝐔 কে-🐸😾🔪 ",
        "বলো কি বলবা, সবার সামনে বলবা নাকি?🤭🤏 ",
        "-আজ একটা বিন নেই বলে ফেসবুকের নাগিন-🤧-গুলোরে আমার বস 𝐊𝐀𝐌𝐔 ধরতে পারছে না-🐸🥲 ",
...
    }
  if ((event.body.toLowerCase() == "hedar bot") || (event.body.toLowerCase() == "baler bot") || (event.body.toLowerCase() == "sawwar bot") || (event.body.toLowerCase() == "karap bot")) {
   ...
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "Owner")) {
     return api.sendMessage("💝🥀𝐎𝐖𝐍𝐄𝐑:- ☞𝐊𝐀𝐌𝐔 𝐀𝐇𝐌𝐄𝐝☜ 💫\n🖤𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 𝐊𝐀𝐌𝐔🖤\n😳𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 𝐧𝐚𝐦𝐞🤓:- ☞ アヤン\n👋For Any Kind Of Help Contact 👉 01328955648", threadID);
   };
